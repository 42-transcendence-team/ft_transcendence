    ...
    <div className="addChatModal__backdrop" onClick={onClose}>
      <div className="addChatModal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="addChatModal__results">
          {loading && <div className="addChatModal__loading">Buscando...</div>}
            ...
            results.map((user) => (
              ...
              >
                ...
                <div className="addChatModal__userInfo">
                  ...
                  <span className="addChatModal__login">@{user.login}</span>
                </div>
              </button>
            ))}

          {!loading && hasSearched && results.length === 0 && (
            <div className="addChatModal__empty">Sin resultados</div>
          )}
