...
function ModalHeader(props: { title?: string; onClose: () => void }) {
  return (
    <div className="modal__header">
      <div></div>
      {props.title && <h2 className="modal__header--title">{props.title}</h2>}
...
export function Modal(props: Props) {
  ...
  const contentClassName = ['modal__content', props.contentClassName]
    .filter(Boolean)
    .join(' ');
  ...
  return (
    <div className={overlayClassName} onClick={props.onClose}>
      <div
        ref={modalRef}
