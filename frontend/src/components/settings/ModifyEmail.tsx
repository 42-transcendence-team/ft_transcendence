...
import { type EmailSettings, updateEmail } from 'api/Settings';
import type React from 'react';
import { Fragment, useEffect, useState } from 'react';
import { FiAlertCircle, FiCheckCircle, FiMail, FiShield } from 'react-icons/fi';
      ...
      >
        <div className="modal-2fa">
          ...
          <p className="modal-2fa__text">
            Para actualizar tu email introduce el código de 6 dígitos de tu app
            de autenticación.
          </p>
