...
export function ChatPanel(props: ChatPanelProps) {
  ...
  // La sala con el mensaje más reciente va la primera; las salas sin
  // actividad quedan al final. El chat activo no se fija en la primera
  // posición para que un mensaje nuevo siempre suba su burbuja arriba.
