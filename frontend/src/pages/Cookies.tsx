import { FiClock, FiServer, FiShield } from 'react-icons/fi';
    ...
    >
      <div className="information-callout information-callout--positive">
        ...
        <div>
          ...
          <p>
            Twenty Four utiliza actualmente las cookies necesarias para la
            autenticación y la seguridad de las cuentas. No utiliza cookies
            publicitarias ni de análisis.
          </p>
        </div>
      </div>
      ...
      <InformationSection title="Cookies utilizadas por Twenty Four">
        <div className="cookie-grid">
          {cookies.map((cookie) => (
            <article className="cookie-card" key={cookie.name}>
              <header className="cookie-card__header">
                <code className="cookie-card__name">{cookie.name}</code>
              ...
              <dl className="cookie-card__details">
                ...
                <div>
                  ...
                  <dd>
                    HttpOnly. El código JavaScript del cliente no puede leer su
                    contenido.
                  </dd>
                </div>
                ...
                <div>
                  <dt>Seguridad</dt>
                  <dd>
                    SameSite=Lax y Secure cuando la aplicación se ejecuta en
                    producción.
                  </dd>
                </div>
      ...
      <InformationSection title="Datos de sesión almacenados en el servidor">
        <div className="information-inline">
          ...
          <p>
            Los identificadores de sesión, la información temporal de
            autenticación y el estado de conexión también pueden almacenarse en
            el servidor. Esta información no se guarda como una cookie adicional
            en el navegador.
          </p>
        </div>
      </InformationSection>
      ...
      <InformationSection title="Gestión de las cookies">
        <div className="information-inline">
          ...
          <p>
            Bloquear las cookies esenciales impedirá iniciar sesión y hará que
            otras funciones que requieren autenticación no funcionen
            correctamente.
          </p>
        </div>
      </InformationSection>
      ...
      <InformationSection title="Cambios en esta política">
        <p>
          Esta página se actualizará si Twenty Four incorpora cookies
          opcionales, servicios externos de análisis u otras tecnologías de
          seguimiento.
        </p>
      </InformationSection>
    </InformationalPageLayout>
