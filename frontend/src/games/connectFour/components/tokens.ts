...
export function drawPiece({ctx, x, y, width, height, type, preview = false}: {
	ctx: CanvasRenderingContext2D; x: number; y: number; width: number; height: number; type: "R" | "Y"; preview?: boolean;
}) {
