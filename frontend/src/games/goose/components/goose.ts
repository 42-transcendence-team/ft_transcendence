...
import { wait, animateMove } from "./actions";
...
const GOOSE_FLOCK: FlyingGoose[] = [
	{ x: 0.00, y: 0.15, size: 0.24, delay: 0.00, phase: 0.0 },
	{ x: 0.14, y: 0.23, size: 0.18, delay: 0.04, phase: 1.2 },
	{ x: 0.28, y: 0.15, size: 0.20, delay: 0.08, phase: 2.4 },

	{ x: 0.07, y: 0.36, size: 0.16, delay: 0.06, phase: 0.8 },
	{ x: 0.20, y: 0.31, size: 0.14, delay: 0.10, phase: 2.0 },
	{ x: 0.34, y: 0.36, size: 0.17, delay: 0.14, phase: 3.0 },

	{ x: 0.13, y: 0.48, size: 0.28, delay: 0.02, phase: 1.5 },
	{ x: 0.30, y: 0.50, size: 0.22, delay: 0.09, phase: 2.8 },
	...
	{ x: 0.37, y: 0.60, size: 0.16, delay: 0.22, phase: 3.2 },

	{ x: 0.12, y: 0.77, size: 0.12, delay: 0.16, phase: 1.0 },
	{ x: 0.27, y: 0.82, size: 0.10, delay: 0.23, phase: 2.2 },
	{ x: 0.42, y: 0.76, size: 0.13, delay: 0.28, phase: 3.5 },
];



export function drawFlyingGeese(ctx: CanvasRenderingContext2D,
...
export async function animateGoose(action: GooseAction, context: GooseAnimationContext): Promise<void> {
	...
	context.state.message = action.payload ?? "De oca a oca y tiro porque me toca";
...
async function animateFlyingGeese(context: GooseAnimationContext): Promise<void> {
	const duration = 1400;
