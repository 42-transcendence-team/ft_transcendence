import { getPosition, type GooseAnimationContext } from "./actions";
import type { GooseAction, GoosePlayerState } from "../useGoose";

export async function animateFinish(action: GooseAction, context: GooseAnimationContext): Promise<void> {
