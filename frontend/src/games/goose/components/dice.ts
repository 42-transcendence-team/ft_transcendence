...
export function drawDiceAnimation(
	...
	/*
	 * Rotación de los dados mientras ruedan.
	 */
	...
	/*
	 * Durante la primera parte de la animación los números
	 * cambian rápidamente.
	 */
...
export async function animateDice(
	action: GooseAction,
