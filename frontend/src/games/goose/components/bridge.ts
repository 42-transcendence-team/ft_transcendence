...
export function drawBridgeAnimation(
	...
	/*
	 * El puente se construye desde los extremos
	 * hacia el centro.
	 */
	...
	for (
		...
		/*
		 * Cada tabla cae ligeramente desde arriba.
		 */
